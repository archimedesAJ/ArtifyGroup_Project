		...
		if (empty($result)){
			...
			if (password_verify($password, $result['customer_pass'])){
				...
				if (isset($_SESSION['ip_add'])){
                    ...
                    echo ("<script>alert('Login Successfully'); window.location.href = '../view/checkout.php';</script>");
					//header("Location: ../index.php");
				}
				else{
					//header("Location: ../index.php");
                    echo ("<script>alert('Login Successfully! Customer'); window.location.href = '../index.php';</script>");
				}
