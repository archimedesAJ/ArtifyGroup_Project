        ...
        <div class="col-md-8">
           ...
           if (empty($cart)){
            ...
            <div class="d-flex flex-row justify-content-between align-items-center p-2 bg-white mt-4 px-3 rounded">
                ...
                <div class="d-flex flex-row align-items-center qty">
                    <h5 class="text-grey"><?php echo $value['qty']?></h5>
                </div>
            ...
            <br>
            <br>
            <a href="Allproduct.php" class="btn btn-lg btn-warning cart_button_checkout">Continue Shopping </a>
            <a href="checkout.php" class="btn btn-lg btn-primary cart_button_checkout center ">Proceed to CheckOut </a>
        </div>
    </div>
</div>
<br>
