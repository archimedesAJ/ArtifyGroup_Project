      ...
      <div class="modal-body">
        <form id="add-brand-form" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-12">
              <button type="button" class="btn btn-primary add-brand" id="add_brand_btn">Add Brand</button>
            </div>
          </div>
      ...
      <div class="modal-body">
        <form id="edit-brand-form" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-12">
              <button type="button" class="btn btn-primary edit-brand-btn" name="updateBrandID">Update Brand</button>
            </div>
          </div>
